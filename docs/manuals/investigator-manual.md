...
This manual describes the main activities of the Investigator-role in I3LUNG 1.00: Entering data, Handling Discrepancies and Signing Subjects.
...
[Your "Home" in I3LUNG](#your-home-in-I3LUNG)
...
To use I3LUNG you need a browser. You can use Firefox (Mozilla) version 3 or higher, Microsoft Internet Explorer version 7 or higher, Google Chrome or Safari (Mac). Furthermore your browser must be set up to execute Java-script.
...
To start I3LUNG, type in the address you've been given, e. g. [https://I3LUNG.org/lc-demo/](https://I3LUNG.org/lc-deb10/pages/login/login) and the login-screen appears.
...
Adding a Study Visit for a Study Subject is called Scheduling an Event in I3LUNG. Before you can start DataEntry you must schedule the Event. This can be done:
...
For this electronic signature to be valid, you must supply your username plus your I3LUNG-password. This must be repeated for very subject that you sign.
